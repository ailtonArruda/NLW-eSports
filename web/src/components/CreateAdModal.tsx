...
export function CreareAdModal() {
    const [games, setGames] = useState<Game[]>([]);
    const [weekDays, setWeekDays] = useState<string[]>([]);
    const [useVoiceChannel, setUseVoiceChanner] = useState(false);
              ...
              <Dialog.Title className='text-3xl font-black'>
                ...
                <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
                  <div className="flex flex-col gap-2">
                    ...
                    <select
                        className="bg-zinc-900 py-3 px-4 round text-sm placeholder:text-zinc-500"
                        id="game"
                        name="game"
                        defaultValue=""
                    >
                  ...
                  <label className="mt-2 flex gap-2 text-sm">
                    <Checkbox.Root 
                      ...
                      onCheckedChange={(checked) => {
                        if (checked === true) {
                          setUseVoiceChanner(true)
                        } else {
                          setUseVoiceChanner(false)
                        }
                      }}
